...
public class DespesasController {
	...
	public String RegistraPrePlantio(@Valid PrePlantio p, BindingResult result, HttpSession session)
			throws SQLException {
		if (result.hasErrors()) {
	...
	public String RegistraPlantio(@Valid Plantio p, BindingResult result, HttpSession session) throws SQLException {
		if (result.hasErrors()) {
			return "redirect:despesas";
		}
	...
	public String RegistraColheita(@Valid Colheita p, BindingResult result, HttpSession session) throws SQLException {
		if (result.hasErrors()) {
			return "redirect:despesas";
		}
	...
	public String RegistraPosColheita(@Valid PosColheita p, BindingResult result, HttpSession session)
			throws SQLException {
		if (result.hasErrors()) {
			return "redirect:despesas";
		}
	...
	public String RegistraInsumos(@Valid Insumos p, BindingResult result, HttpSession session) throws SQLException {
		if (result.hasErrors()) {
			return "redirect:despesas";
		}
	...
	public String RegistraBeneficiamento(@Valid Beneficiamento p, BindingResult result, HttpSession session)
			throws SQLException {
		if (result.hasErrors()) {
			return "redirect:despesas";
		}
	...
	public String RegistraManutencaoLavoura(@Valid ManutencaoLavoura p, BindingResult result, HttpSession session)
			throws SQLException {
		// if(result.hasErrors()){
		// return "redirect:despesas";
		// }
	...
	public String RegistraDespesasAdd(@Valid DespesaAdd p, BindingResult result, HttpSession session)
			throws SQLException {
		if (result.hasErrors()) {
			return "redirect:despesas";
		}
